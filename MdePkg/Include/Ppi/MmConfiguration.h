/** @file
  EFI MM Configuration PPI as defined in PI 1.5 specification. This
  PPI reports the portions of MMRAM regions which cannot be used for the MMRAM
  heap.
...
#ifndef MM_CONFIGURATION_PPI_H__
#define MM_CONFIGURATION_PPI_H__
