...
extern TPM2_PTP_INTERFACE_TYPE  mActiveTpmInterfaceType;
  ...
  )
{
  ...
  //
  if (mCRBIdleByPass == 0 && (MmioRead32((UINTN)&CrbReg->CrbControlStatus) & PTP_CRB_CONTROL_AREA_STATUS_TPM_IDLE) == 0){
    Status = PtpCrbWaitRegisterBits (
